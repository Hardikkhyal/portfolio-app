...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative w-full py-28 bg-luxury-bg select-none z-30 overflow-hidden"
    >
      ...
      <div className="absolute inset-0 w-full h-full flex flex-col justify-between py-12 pointer-events-none z-0">
        {marquees.map((m, idx) => (
          <div key={idx} className="relative w-full flex overflow-hidden select-none">
            ...
            <div
              className={`flex gap-4 font-black uppercase text-white/[0.015] text-[6.5vw] leading-none tracking-tighter ${
                    ...
                    <div className="flex flex-wrap gap-2.5">
                      {services.map((service) => (
                        <button
                          ...
                          className={`relative px-5 py-3 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-500 cursor-pointer border ${
